...
class LaporanKurirAdapter(
    private val context: Context,
    private val laporanKurirList: List<LaporanKurir>,
    ...
    override fun onBindViewHolder(holder: LaporanItemViewHolder, position: Int) {
        holder.bind(laporanKurirList[position], holder.adapterPosition, listener as OnItemClickListener)
    }
    ...
    class LaporanItemViewHolder(var binding: GridLaporanBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(laporanKurir: LaporanKurir, position: Int, listener: OnItemClickListener) {
